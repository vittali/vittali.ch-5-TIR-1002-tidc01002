...
driver example.  Only the example resources are listed in the table.
  ...
  |`Board_I2C0`|P01, P02|
  |`Board_I2C_TMP`|P01, P02  (__SCL__ & __SDA__ must be jumpered)|
  |`Board_I2S0`|P50, P53, P62, P63, P64|
  |`Board_PWM0`|P01  (__LED EN__ must be jumpered)|
  |`Board_PWM1`|P02  (__LED EN__ must be jumpered)|
  |`Board_SDSPI0`|P05, P06, P07, P62|
  |`Board_SD0`|P05, P06, P07, P62|
  |`Board_SDFatFS0`|P05, P06, P07, P62|
  |`Board_SPI0`|P05, P06, P07, P08|
  |`Board_UART0`|P57, P55 UART provided through emulation (__RX__ and __TX__ must be jumpered)|
  |`Board_UART1`|P08, P07|
